...
intro: A curated list of awesome bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem.
Tags: Awesome Laravel
Status: public
Toc: yes
Position: 1
...
* [Laravel Datatable](https://github.com/yajra/laravel-datatables) - jQuery DataTables API for Laravel 4|5
