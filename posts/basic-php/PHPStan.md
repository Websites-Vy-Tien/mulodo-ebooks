...
intro: PHPStan focuses on finding errors in your code without actually running it. It catches whole classes of bugs
even before you write tests for the code.
Tags: PHPStan - PHP Static Analysis Tool
Status: public
Toc: yes
Position: 1
